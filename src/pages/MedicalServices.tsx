          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                ...
                <p className="text-blue-100">Mon-Fri: 9AM - 5PM</p>
                <p className="text-blue-100">Saturday: By Appointment</p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
                ...
                <p className="text-blue-100">Fax: 416-293-5214</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Saturday Appointments</h3>
              <p className="text-lg text-gray-700 mb-4">
                For Saturday appointments, please email:
              </p>
              <a
